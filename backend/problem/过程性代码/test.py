...
# 获取当前日期
current_date = os.getenv('current_date', datetime.date.today())
...
# 改进后的代码，开始爬取数据
for x in range(1,10):  # 假设我们要爬取前两页的数据
...
# 保存数据
# df.to_csv('./data/' + current_date + '市场价格.csv', index=False, encoding='utf-8')
df.to_csv('./data/' + str(current_date) +'市场价格.csv', index=False, encoding='utf-8')